  ...
  menu_2()
    ...
    def menu_condicionales(): 
     ...
     if menu3=='1':
       ...
       elif numero1 == numero2:print("El numero 1: ",numero1, " y el numero 2: ",numero2, "son iguales")
       else:print("El numero ",numero2, "es mayor","\nEl numero ",numero1, "es menor" )  
       time.sleep(2)
       return menu_condicionales()     
     elif menu3=='3':
         os.system('cls')
